...
public class LocationService3 extends Service {
    ...
    public void onCreate() {
        ...
        Intent clsIntent = new Intent(LocationService3.this, MainActivity.class);
        PendingIntent pendingIntent = PendingIntent.getActivity(LocationService3.this, 0, clsIntent, 0);
    ...
    public void checkScore(Location location) {
        int locationScore = getLocationScore(LocationService3.this, real, location, tryNum);
