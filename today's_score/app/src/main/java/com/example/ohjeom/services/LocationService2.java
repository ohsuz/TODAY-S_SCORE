...
public class LocationService2 extends Service {
    ...
    public void onCreate() {
        ...
        Intent clsIntent = new Intent(LocationService2.this, MainActivity.class);
        PendingIntent pendingIntent = PendingIntent.getActivity(LocationService2.this, 0, clsIntent, 0);
